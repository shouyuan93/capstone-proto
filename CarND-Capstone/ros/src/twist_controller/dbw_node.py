...
class DBWNode(object):
	...
	acc_ki = 0.003
	acc_kd = 3.0
	#all paras to Controller in class Contreller set
	"""
    ...
    def loop(self):
		...
		if self.enabled and (self.required_linear_velocity is not None) and (self.current_linear_velocity is not None):
			throttle,brake,steering=self.controller.control(self.current_linear_velocity,self.required_linear_velocity,self.required_angular_velocity)
